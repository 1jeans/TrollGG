...
<head>
    ...
    <script src="https://cdnjs.	udflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js"
        ...
        <div class="col-lg-12">
            <div class="page-content">
                ...
                <div class="mContainer" style="display: flex;">
                    <div align="center">
                        <img id="rankcover" src="" style="width: 7%; position: absolute;"/> <img id="usericon"
                                                                                                 src="/resource/res/img/profileIcon.jpg"
                    ...
                    <div style="padding: 15px;">
                        <div id="name" style="font-size: 25px; color: white;"></div>
                        ...
                        <br/>
                        <button class="search_button" id="reSearchUser" style="padding: 0px 14px;
    border-radius: 4px;
    font-size: 14px;
    margin-right: 8px;
    height: 40px;
...
">전적 갱신
                ...
                <div class="mContainer" style="display: flex;">
                    <!--탭 메뉴 영역 -->
                    <ul class="tabs">
                        <li style="margin-right: 30px; background-color: #FFFFFF;">
                            <a href="#tab1" style="width: 100px; height: 35px; display: flex; justify-content: center; align-items: center;">종합</a>
                        </li>

                        <li style="border-left: 1px solid #999;"><!-- 인게임 정보 api : spectator -->
                            <a href="#tab2" style="height: 100%; background-color: white; color: #343a40 ; display: flex; justify-content: center;">
                            인게임 정보
                    ...
                    <div id="tab1" class="tab_content">
                        ...
                        <div class="mContainer" style="display: flex;">
                            ...
                            <div id="left-container" style="width: 30%;">
                                <!-- 솔랭 정보 -->
                                <div
                                        style="display: flex; background-color: #31313C; justify-content: center; align-items: center; border-radius: 5px;">
                                    <div style="display: flex;">
                                        <img id="rankimg" style="width: 150px; height: 150px;"
                                             src="/resource/res/img/emblems/Emblem_UNRANKED.png"/>
                                    </div>
                                    <div style="margin-left: 20px; height: 130px; display: flex; flex-direction: column; justify-content: center; color:white;">
                                ...
                                <div
                                        style="display: flex; background-color: #31313C; justify-content: center; align-items: center; border-radius: 5px;">
                                    <div style="display: flex;">
                                        <img id="trankimg" style="width: 150px; height: 150px;"
                                             src="/resource/res/img/emblems/Emblem_UNRANKED.png"/>
                                    </div>
                                    <div style="margin-left: 20px; height: 130px; display: flex; flex-direction: column; justify-content: center; color:white;">
                                        ...
                                        <div style="display: flex;">
                                            <div id="ttier"
                                                 style="display: flex; font-size: 12px; color: #63B8E5;"></div>
                                            <div id="trank"
                                                 style="font-size: 12px; color: #63B8E5; margin-left: 5px;"></div>
                                        </div>
                            ...
                            <div id="right-container" style="width: 70%; margin-left: 5px;">
                                <!-- 승률 박스 -->
                                <div style="display: flex; background-color: #31313C; border-radius: 5px;">

                                    <!-- 1번 박스 -->
                                    <!-- 승률 -->
                                    <div style="display: flex; flex-direction: column; width: 40%; padding: 20px; color:white; margin-left: 35px;">
                                        <div style="display: flex; font-size: 13px; color: white; padding-bottom: 10px;">
                                        ...
                                        <div style="display: flex;">
                                            ...
                                            <div style="width: 100px; height: 100px; display: flex; justify-content: center; align-items: center;">
                                                <!-- 승률 text -->
                                                <div id="winPerStat" style="position: absolute; font-size: 18px;">%
                                                </div>
                                                <!-- 승률 graph -->
                                    ...
                                    <div style="width: 35%; padding: 10px;">
                                        <div style="display: flex; flex-direction: column; margin: 5% 5% 0 10%; color:white;">
                                            <!-- 승률 -->
                                            <c:forEach var="b" begin="1" end="3" step="1">
                                                <div style="display: flex; align-items: center; margin-bottom: 10px;">
                                                    ...
                                                    <div>
                                                        <!-- 승률 챔피언 이름 -->
                                                        <div class="mostChampion" id="championName${b}"
                                                             style="font-size: 12px;"></div>
                                                        <div style="display: flex;">
                                                            <!-- 승률 승률-->
                                                            <div id="championRate${b}"
                                                                 style="font-size: 10px; color: red;"></div>
                                                            <!-- 승률 승패-->
                                                            <div id="championWinRate${b}"
                                    ...
                                    <!-- 3번 박스 -->
                                    <!-- 포지션별 랭크 -->
                                    <div style="width: 25%; padding: 20px; font-size: 12px; color: white; display: flex; flex-direction: column;">
                                        선호 포지션 (랭크)
                                        <c:forEach var="a" begin="1" end="2" step="1">
                                            <div style="margin-top: 25px;">
                                                <div id="position${a}"></div>
                                                <div style="display: flex;">
                                                    <div id="positionRate${a}"
                                                         style="color: #1F8ECD; margin-right: 5px;"></div>
                                                    |
                                ...
                                <c:forEach var="num" items="${matchId}" varStatus="status">
                                    ...
                                    <div style="display: flex; flex-direction: column; justify-content: center; align-items: center; margin-bottom: 10px; ">
                                        <!-- 전적 박스 -->
                                        <div id="searchBox${status.index}"
                                             style="display: flex; background-color: #28344E; width: 100%;border-radius: 5px;">
                                            <!-- 겜 정보 -->
                                            <div
                                                    style="display: flex; flex-direction: column; justify-content: center; align-items: center; font-size: 12px; margin: 10px 10px 10px 0; width: 14%; color:white;">
                                                <div id="gameSort${status.index}" style="white-space: nowrap;"></div>
                                                <div id="gameTime${status.index}"></div>
                                                <hr style="width: 20px;"/>
                                                <div id="winOrLose${status.index}" style="color: #2F436E;"></div>
                                            ...
                                            <div
                                                ...
                                                <div style="display: flex;">
                                                    ...
                                                    <div style="display: flex; flex-direction: column; margin-right: 5px;">
                                                        <img id="spellD${status.index }" src=""
                                                             style="width: 25px; height: 25px;"/> <img
                                                            id="spellF${status.index}" src=""
                                                            style="width: 25px; height: 25px;"/>
                                                    </div>
                                                    <!-- 룬 -->
                                                    <div style="display: flex; flex-direction: column;">
                                                        <img id="RuneMain${status.index }" src=""
                                                             style="width: 25px; height: 25px; border-radius: 30px;"/>
                                                        <img
                                                                id="RuneSub${status.index }" src=""
                                                                style="width: 25px; height: 25px; border-radius: 30px;"/>
                                                    </div>
                                                </div>
                                                <div id="boxChampionName${status.index}"
                                                     style="font-size: 12px; margin-top: 5px;">챔프이름
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <div
                                                        style="display: flex; justify-content: center; align-items: center; font-size: 13px; font-weight: bold; color: white; margin-bottom: 5px;">
                                                ...
                                                <div
                                                        style="display: flex; justify-content: center; align-items: center; font-size: 11px; font-weight: bold; color: white; margin-bottom: 5px;">
                                                    <div id="box${status.index}Kda"
                                                         style="color: #9E9EB1; white-space: nowrap;"></div>
                                                    <div style="font-weight: normal; font-size: 10px; white-space: nowrap;">
                                                        평점
                                                    </div>
                                                </div>
                                            ...
                                            <!-- 레벨, cs, 킬관여 -->
                                            <div
                                                    style="display: flex; justify-content: center; align-items: center; flex-direction: column; color: white; font-size: 11px; margin-right: 20px;">
                                                <div id="box${status.index}Level" style="margin-bottom: 5px;">레벨 18
                                                </div>
                                                ...
                                                <div id="box${status.index}KillRel" align="center"
                                                     style="color: red; margin-bottom: 5px; font-size: 10px; white-space: nowrap; font-weight: bold;">
                                                    킬관여
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <div style="display: flex; justify-content: center; align-items: center;">
                                                    <div style="width: 25px; height: 25px; background-color: #9e9e9e; border-radius: 5px; margin: 0 1px 2px 1px;">
                                                        <img id="box${status.index}Item1"
                                                             style="border-radius: 5px; opacity: 1; width: 25px; height: 25px;"
                                                             src="/resource/res/img/opacity.png"/>
                                                    </div>
                                                    <div style="width: 25px; height: 25px; background-color: #9e9e9e; border-radius: 5px; margin: 0 1px 2px 1px;">
                                                        <img id="box${status.index}Item2"
                                                             style="border-radius: 5px; opacity: 1; width: 25px; height: 25px;"
                                                             src="/resource/res/img/opacity.png"/>
                                                    </div>
                                                    <div style="width: 25px; height: 25px; background-color: #9e9e9e; border-radius: 5px; margin: 0 1px 2px 1px;">
                                                        <img id="box${status.index}Item3"
                                                             style="border-radius: 5px; opacity: 1; width: 25px; height: 25px;"
                                                             src="/resource/res/img/opacity.png"/>
                                                    </div>
                                                    <!-- 와드, 장신구 7번 박스 -->
                                                    <div style="width: 25px; height: 25px; background-color: #9e9e9e; border-radius: 5px; margin: 0 1px 2px 1px;">
                                                        <img id="box${status.index}Item7"
                                                             style="border-radius: 5px; opacity: 1; width: 25px; height: 25px;"
                                                             src="/resource/res/img/opacity.png"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div style="display: flex; justify-content: center; align-items: center;">
                                                    <div style="width: 25px; height: 25px; background-color: #9e9e9e; border-radius: 5px; margin: 0 1px 2px 1px;">
                                                        <img id="box${status.index}Item4"
                                                             style="border-radius: 5px; opacity: 1; width: 25px; height: 25px;"
                                                             src="/resource/res/img/opacity.png"/>
                                                    </div>
                                                    <div style="width: 25px; height: 25px; background-color: #9e9e9e; border-radius: 5px; margin: 0 1px 2px 1px;">
                                                        <img id="box${status.index}Item5"
                                                             style="border-radius: 5px; opacity: 1; width: 25px; height: 25px;"
                                                             src="/resource/res/img/opacity.png"/>
                                                    </div>
                                                    <div style="width: 25px; height: 25px; background-color: #9e9e9e; border-radius: 5px; margin: 0 1px 2px 1px;">
                                                        <img id="box${status.index}Item6"
                                                             style="border-radius: 5px; opacity: 1; width: 25px; height: 25px;"
                                                             src="/resource/res/img/opacity.png"/>
                                                    </div>
                                                    <div style="width: 25px; height: 25px;">
                                                        <img id="box${status.index }ItemBuild"
                                                             src="/resource/res/img/searchbuild.png"
                                            ...
                                            <div style="display: flex; justify-content: center; align-items: center; width: 30%; ">
                                                ...
                                                <div style="display: flex; justify-content: center; align-items: flex-start; flex-direction: column; margin-right: 10px;">
                                                    ...
                                                    <c:forEach var="a" begin="0" end="4" step="1">
                                                        <div
                                                                style="display: flex; justify-content: center; align-items: center; font-size: 10px; color: white; margin-bottom: 3px;">
                                                            <img id="box${status.index}ChampImg${a}" src=""
                                                                 style="width: 15px; height: 15px; margin-right: 3px;"/>
                                                            <div id="box${status.index}TeamName${a}"
                                                                 style="width: 70px; display: block; text-overflow: ellipsis; overflow: hidden; white-space: nowrap;">
                                                                소환사 이름
                                                            </div>
                                                        </div>
                                                    </c:forEach>
                                            ...
                                            <!-- 전적 토글 버튼 -->
                                            <a id="search${status.index}" class="a_search" href="javascript:void(0);"
                                               onclick="doDisplay(this);"
                                               style="background-color: #2F436E; width: 5%; display: flex; justify-content: center; align-items: flex-end; border-radius: 5px;">
                                                <img id="moreButton${status.index}" src="/resource/res/img/winMore.png"
                                        ...
                                        <div id="matchSpecificBox${status.index}"
                                             style=" display: none; width: 100%;">
                                            <div id="matchSpecificBoxhidden${status.index}" style="display:none">0</div>
                                            <!-- 머리글 행 -->
                                            <div style="display: flex; color: white; font-size: 10px; padding: 5px; border-bottom: 1px solid #bcbcbc;">
                                                <div style="width: 25%; display: flex;">
                                                    <div id="SpwinOrlose${status.index}" style="color: #1A85C4;">승리
                                                    </div>
                                                    <div>(블루팀)</div>
                                                </div>
                                            ...
                                            <c:forEach var="team" begin="0" end="4" step="1">
                                                ...
                                                <div id="detailBox${status.index }${team }"
                                                     style="display: flex; color: white; font-size: 11px; background-color: #28344E; height: 50px;">
                                                    <div style="display: flex; align-items: flex-end;">
                                                        <div id="detailBox${status.index }TeamLevel${team }"
                                                             style="width: 8px;"></div>
                                                    </div>
                                                    <div style="width: 25%; display: flex; align-items: center;">
                                                        <img id="detailBox${status.index }TeamChampImg${team }"
                                                             class="circle_image" src=""
                                                             style="width: 45px; height: 45px; margin-right: 5px; border-radius: 30px;"/>
                                                        <div style="display: flex; flex-direction: column; margin-right: 5px;">
                                                            <img id="detailBox${status.index }TeamSpellD${team}" src=""
                                                                 style="width: 20px; height: 20px;"/> <img
                                                                id="detailBox${status.index }TeamSpellF${team}" src=""
                                                                style="width: 20px; height: 20px;"/>
                                                        </div>
                                                        <!-- 룬 -->
                                                        <div style="display: flex; flex-direction: column;">
                                                            <img id="detailBox${status.index }TeamRuneMain${team }"
                                                                 src=""
                                                                 style="width: 20px; height: 20px; border-radius: 30px;"/>
                                                            <img id="detailBox${status.index }TeamRuneSub${team }"
                                                                 src=""
                                                                 style="width: 20px; height: 20px; border-radius: 30px;"/>
                                                        </div>
                                                        <span id="detailBox${status.index }TeamName${team }"
                                                              style="font-size: 10px; margin-top: 5px; white-space: nowrap;"></span>
                                                    </div>
                                                    <!-- 티어 -->
                                                    <div
                                                            style="width: 10%; display: flex; justify-content: center; align-items: center; font-size: 10px; white-space: nowrap;">
                                                        <div id="detailBox${status.index }TeamTier${team }"
                                                             style="margin-right: 5px; white-space: nowrap;"></div>
                                                    ...
                                                    <div style="width: 15%; display: flex; justify-content: center; align-items: center;">
                                                        <div
                                                            ...
                                                            <!-- 피해량 text -->
                                                            <div id="detailBox${status.index }TeamDamage${team }"
                                                                 style="font-size: 11px;">25,537
                                                            </div>
                                                            <!-- 피해량 graph -->
                                                            <div style="background-color: #F2F2F2; width: 80px; height: 15px;">
                                                                <div id="detailBox${status.index }TeamDamagePer${team }"
                                                    ...
                                                    <div style="width: 30%; display: flex; justify-content: center; align-items: center;">
                                                        <div style="display: flex; justify-content: center; align-items: center;">
                                                            <div id="detailBox${status.index }Team${team}Item1"
                                                                ...
                                                                <img id="detailBox${status.index }Team${team }Item1Img"
                                                                     src="/resource/res/img/opacity.png"
                                                                     style="width: 20px; height: 20px;"/>
                                                            </div>
                                                            <div id="detailBox${status.index }Team${team}Item2"
                                                                 style="width: 20px; height: 20px; background-color: #9e9e9e; border-radius: 5px; margin: 0 1px 0 1px;">
                                                                <img id="detailBox${status.index }Team${team }Item2Img"
                                                                     src="/resource/res/img/opacity.png"
                                                                     style="width: 20px; height: 20px;"/>
                                                            </div>
                                                            <div id="detailBox${status.index }Team${team}Item3"
                                                                 style="width: 20px; height: 20px; background-color: #9e9e9e; border-radius: 5px; margin: 0 1px 0 1px;">
                                                                <img id="detailBox${status.index }Team${team }Item3Img"
                                                                     src="/resource/res/img/opacity.png"
                                                                     style="width: 20px; height: 20px;"/>
                                                            </div>
                                                            <div id="detailBox${status.index }Team${team}Item4"
                                                                 style="width: 20px; height: 20px; background-color: #9e9e9e; border-radius: 5px; margin: 0 1px 0 1px;">
                                                                <img id="detailBox${status.index }Team${team }Item4Img"
                                                                     src="/resource/res/img/opacity.png"
                                                                     style="width: 20px; height: 20px;"/>
                                                            </div>
                                                            <div id="detailBox${status.index }Team${team}Item5"
                                                                 style="width: 20px; height: 20px; background-color: #9e9e9e; border-radius: 5px; margin: 0 1px 0 1px;">
                                                                <img id="detailBox${status.index }Team${team }Item5Img"
                                                                     src="/resource/res/img/opacity.png"
                                                                     style="width: 20px; height: 20px;"/>
                                                            </div>
                                                            <div id="detailBox${status.index }Team${team}Item6"
                                                                 style="width: 20px; height: 20px; background-color: #9e9e9e; border-radius: 5px; margin: 0 1px 0 1px;">
                                                                <img id="detailBox${status.index }Team${team }Item6Img"
                                                                     src="/resource/res/img/opacity.png"
                                                                     style="width: 20px; height: 20px;"/>
                                                            </div>
                                                            <div id="detailBox${status.index }Team${team}Item7"
                                                                 style="width: 20px; height: 20px; background-color: #9e9e9e; border-radius: 5px; margin: 0 1px 0 1px;">
                                                                <img id="detailBox${status.index }Team${team }Item7Img"
                                                                     src="/resource/res/img/opacity.png"
                                                                     style="width: 20px; height: 20px;"/>
                                                            </div>
                                                        </div>
                                            ...
                                            <div style="display: flex; justify-content: center; align-items: center; font-size: 12px; height: 50px; background-color: #282830; border-top: 1px solid #bcbcbc; color:white;">
                                                <!-- 블루팀 오브젝트 -->
                                                <div style="display: flex; justify-content: center; align-items: center; width: 25%;">
                                                    <div style="display: flex; justify-content: center; align-items: center; margin-right: 10px;">
                                                        <img src="/resource/res/img/icon-baron-b.png"
                                                             style="width: 20px; height: 20px;"/>
                                                        <div id="blueTeamBaron${status.index }">0</div>
                                                    </div>
                                                    <div style="display: flex; justify-content: center; align-items: center; margin-right: 10px;">
                                                        <img src="/resource/res/img/icon-dragon-b.png"
                                                             style="width: 20px; height: 20px;"/>
                                                        <div id="blueTeamDragon${status.index }">0</div>
                                                    </div>
                                                    <div style="display: flex; justify-content: center; align-items: center; margin-right: 10px;">
                                                        <img src="/resource/res/img/icon-tower-b.png"
                                                             style="width: 20px; height: 20px;"/>
                                                ...
                                                <div style="display: flex; justify-content: center; align-items: center; flex-direction: column; width: 50%;">
                                                    ...
                                                    <div style="display: flex; justify-content: center; align-items: center; width: 100%;">
                                                        ...
                                                        <div id="blueTotalGold${status.index }"
                                                             style="width: 10%; font-size: 10px;">0
                                                        </div>
                                                        <div
                                                                style="display: flex; justify-content: center; align-items: center; width: 65%; height: 10px; margin: 0 5px 0 5px;">
                                                            <div id="blueTotalGoldGraph${status.index }"
                                                                 style="background-color: #548DCA; width: 70%; height: 10px;"></div>
                                                            <div id="redTotalGoldGraph${status.index }"
                                                                 style="background-color: #D05A53; width: 30%; height: 10px;"></div>
                                                        </div>
                                                        <div id="redTotalGold${status.index }"
                                                             style="width: 5%; font-size: 10px;">0
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div style="display: flex; justify-content: center; align-items: center; width: 25%;">
                                                    <div style="display: flex; justify-content: center; align-items: center; margin-right: 10px;">
                                                        <img src="/resource/res/img/icon-baron-r.png"
                                                             style="width: 20px; height: 20px;"/>
                                                        <div id="redTeamBaron${status.index }">0</div>
                                                    </div>
                                                    <div style="display: flex; justify-content: center; align-items: center; margin-right: 10px;">
                                                        <img src="/resource/res/img/icon-dragon-r.png"
                                                             style="width: 20px; height: 20px;"/>
                                                        <div id="redTeamDragon${status.index }">0</div>
                                                    </div>
                                                    <div style="display: flex; justify-content: center; align-items: center; margin-right: 10px;">
                                                        <img src="/resource/res/img/icon-tower-r.png"
                                                             style="width: 20px; height: 20px;"/>
                                            ...
                                            <div style="display: flex; color: white; font-size: 10px; padding: 5px; border-bottom: 1px solid #bcbcbc;">
                                                <div style="width: 25%; display: flex;">
                                                    <div id="SpwinOrloseSide${status.index}" style="color: red;">패배
                                                    </div>
                                                    <div>(레드팀)</div>
                                                </div>
                                                <div style="width: 10%; display: flex; justify-content: center; align-items: center;">
                                            ...
                                            <c:forEach var="team" begin="5" end="9" step="1">
                                                <div id="detailBox${status.index }${team }"
                                                     style="display: flex; color: white; font-size: 11px; background-color: #59343B; height: 50px;">
                                                    <div style="display: flex; align-items: flex-end;">
                                                        <div id="detailBox${status.index }TeamLevel${team }"
                                                             style="width: 8px;">11
                                                        </div>
                                                    ...
                                                    <div style="width: 25%; display: flex; align-items: center;">
                                                        ...
                                                        <div style="display: flex; flex-direction: column;">
                                                            <img id="detailBox${status.index }TeamRuneMain${team}"
                                                                 src=""
                                                                 style="width: 20px; height: 20px; border-radius: 30px;"/>
                                                            <img id="detailBox${status.index }TeamRuneSub${team}" src=""
                                                                 style="width: 20px; height: 20px; border-radius: 30px;"/>
                                                        </div>
                                                        <span id="detailBox${status.index }TeamName${team}"
                                                    ...
                                                    <div style="width: 10%; display: flex; justify-content: center; align-items: center; flex-direction: column;">
                                                        ...
                                                        <div style="font-size: 8px; display: flex; justify-content: center; align-items: center;">
                                                            ...
                                                            /
                                                            <div id="detailBox${status.index }TeamAssist${team }">1
                                                            </div>
                                                            <div id="detailBox${status.index }TeamKillPer${team }">
                                                                (10%)
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div style="width: 70%">
                            ...
                            <div style="border: 1px solid #bcbcbc;">
                                ...
                                <c:forEach var="inGameNum" begin="0" end="4" step="1">
                                    <!-- 상세정보 1행 -->
                                    <div style="display: flex; color: white; font-size: 11px; background-color: #D8E4EC; height: 50px;">
                                        <div style="width: 35%; display: flex; align-items: center;">
                                            <img id="InGameChampImg${inGameNum }" class="circle_image" src=""
                                                 style="width: 45px; height: 45px; margin-right: 5px; border-radius: 30px;"/>
                                            <div style="display: flex; flex-direction: column; margin-right: 5px;">
                                                <img id="InGameSpellD${inGameNum }" src=""
                                                     style="width: 20px; height: 20px;"/> <img
                                                    id="InGameSpellF${inGameNum }" src=""
                                                    style="width: 20px; height: 20px;"/>
                                            </div>
                                            <!-- 룬 -->
                                            <div style="display: flex; flex-direction: column;">
                                                <img id="InGameRuneMain${inGameNum }" src=""
                                                     style="width: 20px; height: 20px; border-radius: 30px;"/>
                                                <img id="InGameRuneSub${inGameNum }"
                                                     src="" style="width: 20px; height: 20px; border-radius: 30px;"/>
                                            </div>
                                            <span id="InGameChampName${inGameNum }"
                                                  style="font-size: 12px; margin-top: 5px;"></span>
                                        </div>
                                        <!-- 티어 -->
                                        <div style="width: 15%; display: flex; justify-content: center; align-items: center;">
                                        ...
                                        <div style="width: 30%; display: flex; justify-content: center; align-items: center;">
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <img id="InGame0Mastery${inGameNum }" src=""
                                                     style="width: 20px; height: 20px; border-radius: 30px; margin-left: 5%;"/>
                                                <img
                                                        id="InGame1Mastery${inGameNum }" src=""
                                                        style="width: 20px; height: 20px; border-radius: 30px; margin-left: 5%;"/>
                                                <img
                                                        id="InGame2Mastery${inGameNum }" src=""
                                                        style="width: 20px; height: 20px; border-radius: 30px; margin-left: 5%;"/>
                                            </div>
                                        </div>
                                        <div style="width: 20%; display: flex; align-items: center; justify-content: center;">
                                            <!-- 밴 -->
                                            <img id="InGameTeamBan${inGameNum }" src=""
                                                 style="width: 20px; height: 20px;"/>
                                        </div>
                                    </div>
                                    <!-- 끝 -->
                                ...
                                <c:forEach var="inGameNum" begin="5" end="9" step="1">
                                    <!-- 상세정보 1행 -->
                                    <div style="display: flex; color: white; font-size: 11px; background-color: #E9E0E0; height: 50px;">
                                        <div style="width: 35%; display: flex; align-items: center;">
                                            <img id="InGameChampImg${inGameNum }" class="circle_image" src=""
                                                 style="width: 45px; height: 45px; margin-right: 5px; border-radius: 30px;"/>
                                            <div style="display: flex; flex-direction: column; margin-right: 5px;">
...
<script>
    ...
    function redWin(i) {
        ...
        // 상세보기 배경 변경
        for (var d = 0; d < 5; d++) {
            document.querySelector("#detailBox" + i + d).style.backgroundColor = "#59343B";
        }
        for (var d = 5; d < 10; d++) {
            document.querySelector("#detailBox" + i + d).style.backgroundColor = "#28344E";
        }
    }
        ...
        if (match != null) {
            ...
            for (var i = 0; i < match.length; i++) {
                ...
                if (temp.win == true) {
                    ...
                    document.querySelector("#searchBox" + i).style.backgroundColor = '#59343B';
                    document.querySelector("#search" + i).style.backgroundColor = '#703C47';
